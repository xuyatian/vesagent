...
XRpcTransport_control_args::~XRpcTransport_control_args() throw() {
}


uint32_t XRpcTransport_control_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t XRpcTransport_control_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("XRpcTransport_control_args");

  xfer += oprot->writeFieldBegin("control", ::apache::thrift::protocol::T_STRUCT, 1);
...
XRpcTransport_control_pargs::~XRpcTransport_control_pargs() throw() {
}


uint32_t XRpcTransport_control_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("XRpcTransport_control_pargs");
...
XRpcTransport_control_result::~XRpcTransport_control_result() throw() {
}


uint32_t XRpcTransport_control_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t XRpcTransport_control_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("XRpcTransport_control_result");
...
XRpcTransport_control_presult::~XRpcTransport_control_presult() throw() {
}


uint32_t XRpcTransport_control_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
int16_t XRpcTransportClient::control(const XRpcControlField& control)
{
  send_control(control);
  return recv_control();
}

void XRpcTransportClient::send_control(const XRpcControlField& control)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("control", ::apache::thrift::protocol::T_CALL, cseqid);

  XRpcTransport_control_pargs args;
...
int16_t XRpcTransportClient::recv_control()
{
  ...
  int16_t _return;
  XRpcTransport_control_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void XRpcTransportProcessor::process_control(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("XRpcTransport.control", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "XRpcTransport.control");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "XRpcTransport.control");
  }

  XRpcTransport_control_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "XRpcTransport.control", bytes);
  }

  XRpcTransport_control_result result;
  try {
    result.success = iface_->control(args.control);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "XRpcTransport.control");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "XRpcTransport.control");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "XRpcTransport.control", bytes);
  }
}
...
int16_t XRpcTransportConcurrentClient::control(const XRpcControlField& control)
{
  int32_t seqid = send_control(control);
  return recv_control(seqid);
}

int32_t XRpcTransportConcurrentClient::send_control(const XRpcControlField& control)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("control", ::apache::thrift::protocol::T_CALL, cseqid);
...
int16_t XRpcTransportConcurrentClient::recv_control(const int32_t seqid)
{
